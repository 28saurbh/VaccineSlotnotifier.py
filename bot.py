...
while(1):
    ...
    x="https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id=1&date="+day
    ...
    if(len(count)>0):
        ...
        for session in count:
            ...
            if(avail > 49):
                msg=[]
                msg.append({"Pincode": session["pincode"], "1":session["name"] , "vaccine":session["vaccine"],"availability":session["available_capacity"],"min-age":session["min_age_limit"],"date":session["date"]})
